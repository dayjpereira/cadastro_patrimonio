...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { departamento_id: @funcionario.departamento_id, nome: @funcionario.nome } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { departamento_id: @funcionario.departamento_id, nome: @funcionario.nome } }
